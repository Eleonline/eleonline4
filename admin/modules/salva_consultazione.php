...
if (isset($param['data_inizio'])) $data_inizio=addslashes($param['data_inizio']); else $data_inizio='';
if (isset($param['data_fine'])) $data_fine=addslashes($param['data_fine']); else $data_fine='';
if (isset($param['link_dait'])) $link_dait=addslashes($param['link_dait']); else $link_dait='';
if (isset($param['tipo'])) $tipo_cons=addslashes($param['tipo']); else $tipo_cons='';
if (isset($param['id_cons_gen'])) $id_cons_gen=addslashes($param['id_cons_gen']); else $id_cons_gen='';
if (isset($param['chiusa'])) $chiusa=addslashes($param['chiusa']); else $chiusa='';
if (isset($param['id_conf'])) $id_conf=addslashes($param['id_conf']); else $id_conf='';
if (isset($param['preferita'])) $preferita=addslashes($param['preferita']); else $preferita='0';
if (isset($param['preferenze'])) $preferenze=addslashes($param['preferenze']); else $preferenze='';
if (isset($param['id_fascia'])) $id_fascia=addslashes($param['id_fascia']); else $id_fascia='';
if (isset($param['vismf'])) $vismf=addslashes($param['vismf']); else $vismf='';
