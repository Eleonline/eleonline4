...
if (!is_dir($pathdoc."/img")) mkdir($pathdoc."/img", 0755, true);
if (!is_dir($pathdoc."/cv")) mkdir($pathdoc."/cv", 0755, true);
if (!is_dir($pathdoc."/cg")) mkdir($pathdoc."/cg", 0755, true);
if (!is_dir($pathdoc."/programmi")) mkdir($pathdoc."/programmi", 0755, true);
if (!is_dir($pathbak."/img")) mkdir($pathbak."/img", 0755, true);
if (!is_dir($pathbak."/cv")) mkdir($pathbak."/cv", 0755, true);
if (!is_dir($pathbak."/cg")) mkdir($pathbak."/cg", 0755, true);
if (!is_dir($pathbak."/programmi")) mkdir($pathbak."/programmi", 0755, true);
