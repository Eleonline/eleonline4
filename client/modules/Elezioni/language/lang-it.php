...
define("_PERC_TEND","Percentuale tendenziale");
define("_PERC_ASS","Percentuale assoluta delle affluenze alle ore");
...
define("_PROIEZCONS","PROIEZIONE DELLA COMPOSIZIONE DEL CONSIGLIO COMUNALE<br>LA FUNZIONE DI CALCOLO E' SPERIMENTALE<br>IL RISULTATO E' PURAMENTE INDICATIVO");
...
define("_SNULLE","Schede Nulle");
define("_SBIANCHE","Schede Bianche");
...
define("_MAPPA","Mappa");
global $id_comune;
if($id_comune=="58047") define("_COMUNE","Citta' di ");
else define("_COMUNE","Comune di ");
...
define("_CNFR_CONS","RAFFRONTO TRA CONSULTAZIONI<br>".htmlentities("si può impostare su liste singole o su raggruppamenti"));
define("_SCELTA_CONS","<b>Scegli le consultazioni da mettere a confronto</b>");
define("_SCEGLI_LISTA","Scegli la Lista");
define("_SCEGLI_CANDI","Scegli il Candidato");
define("_SCEGLI_SEZ","Scegli la Sezione");
define("_SCEGLI_DELEG","Scegli la Circoscrizione");
define("_ESPORTA","Esporta i Risultati");
...
define("_INVIOSEGN","Per rendere questo servizio migliore puoi inviare segnalazioni/suggerimenti a");
define("_CLICCAQUI","questo indirizzo");
define("_GOBACK","[ <a href=\"javascript:history.go(-1)\">Indietro</a> ]");
define("_LINGUA","Linguaggio");
define("_OFF","Disattiva");
define("_ON","Attiva");
define("_BLOCCO","Blocco");
define("_OPTIONS","Opzioni");
define("_ELEZIONI","Elezioni");
define("_TEMA","Tema");
define("_LISTE","Liste");
define("_VOTI_RAGGR","Totale voti alle liste");
define("_PROGRAM","Programma<br>elettorale");
define("_RICARICA","Ricarica");
...
switch ($tipo_cons){
	...
	case 1:
		...
		define("_SIMBOLO","Candidato<br>Presidente");
		...
		define("_ASOLO_GRUPPO","Solo Presidente");
		define("_LISTA","Lista");
		define("_CANDIDATO","Candidato");
	...
	case 11:
		...
		break;
	case 12:
		 define("_SCELTA_CIR","Scegli il Collegio");
		define("_CONSULTAZIONE","Consultazione Elezioni Provinciali");
		define("_SIMBOLO","Candidato<br>Presidente");
		define("_GRUPPI","Candidati Presidente");
		define("_GRUPPO","Candidato Presidente");
	...
	case 18:
		...
		define("_GRUPPI","Candidati Uninominali");
		define("_SOLO_GRUPPO","Voti al solo Candidato Uninominale");
		define("_ASOLO_GRUPPO","Voti al solo<br>Candidato Uninominale");
		define("_LISTA","Lista collegata");
		define("_CANDIDATO","Listino bloccato");
		define("_CONSIGLIO","per il Proporzionale");
		define("_SIMBOLO","Candidato<br>Uninominale");
		define("_DESCRCONS","CAMERA");
		define("_CONSI","Candidato");
		define("_TABGRUPPO","gruppo");
		break;
    case 19:
