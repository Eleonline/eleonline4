...
*************************/
	...
	list($fascia)=$rescomu->fetch(PDO::FETCH_NUM);
        echo "\n";
	echo ' <table style="border:0px;text-align:left;border-collapse: collapse;"><tr><td>
	...
	***********************************/
    ...
    <img src=\"modules/Elezioni/images/logo.gif\" width=\"16\" height=\"16\" class=\"nobordo\" alt=\"logo\"> $descrizione</a></li>";
			}
		      echo "</ul></li>";
