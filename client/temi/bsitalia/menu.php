...
*/
	...
	***********************************/
	...
	if ($multicomune=='1')
	{
	      ...
	      if ($esiste_multi>=1) {
		    echo " <li style=\"min-width:15%;\">
				<a class=\"submenu\" href=\"#\"><strong>"._COMUNI."</strong></a>
	...
	***********************************/
	...
	if ($esiste>=1) {
	echo " <li style=\"min-width:20%;\">
	      <a class=\"submenu\" href=\"#\"><strong>"._ELEZIONI."</strong></a>
	    <ul>";
	...
	***********************************/
       ...
       echo " <li><a class=\"submenu\" href=\"#\"><strong>"._INFO."</strong></a>
	    <ul>";
	    echo "
...
";
	...
	list($num_circ) = $res->fetch(PDO::FETCH_NUM);
       	 echo " <li style=\"min-width:20%;\"><a class=\"submenu\" href=\"#\"><strong>"._RISULTATI."</strong></a>
	    <ul>";
	...
	***********************************/
      ...
      echo " <li style=\"min-width: 7em;\"><a class=\"submenu\" href=\"#\"><strong>"._GRAFICI."</strong></a>
	    <ul>";
		...
		echo "<li class=\"icon stat\"><a href=\"modules.php?id_cons_gen=$id_cons_gen&amp;name=Elezioni&amp;id_comune=$id_comune&amp;file=index&amp;op=graf_votanti\">"._VOTI."</a><span></span></li>"; 
		if (($genere==5 and $votog) or !$votog)
