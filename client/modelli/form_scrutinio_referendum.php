...
<head>
    <meta charset="UTF-8">
    <title>Scrutinio Referendum</title>
</head>
<body>
    <h2>Genera moduli di scrutinio per il Presidente di Seggio</h2>
    <form action="genera_pdf_scrutinio_referendum.php" method="post" target="_blank">
