...
<head>
    <meta charset="UTF-8">
    <title>Stampa modulo di Scrutinio Candiati Sindaco + Liste</title>
</head>
<body>
    <h2>Genera modulo di scrutinio Candiati Sindaco + Liste</h2>
    <form action="genera_pdf_scrutinio_sindaco_liste.php" method="post" target="_blank">
