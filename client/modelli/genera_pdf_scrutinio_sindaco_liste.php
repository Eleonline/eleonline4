...
<table>
    <thead>
        <tr>
            ...
            <th style="width: 22%;">VOTI SOLO CANDIDATO SINDACO</th>
        </tr>
    </thead>
    <tbody>
...
<table>
    <thead>
        <tr>
            ...
            <th style="width:18%;">VOTI</th>
			<th style="width: 22%;">VOTI ALLE SOLO LISTE</th>
        </tr>
    </thead>
    <tbody>
...
$dompdf->render();
$dompdf->stream("scrutinio_sindaco_liste.pdf", ["Attachment" => false]);
